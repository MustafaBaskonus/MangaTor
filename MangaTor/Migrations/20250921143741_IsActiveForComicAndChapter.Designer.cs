...
namespace MangaTor.Migrations
{
    ...
    [Migration("20250921143741_IsActiveForComicAndChapter")]
    partial class IsActiveForComicAndChapter
    {
            ...
            modelBuilder.Entity("DAL.Entities.Comic", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ComicId = 1,
                            DateTime = new DateTime(2025, 9, 21, 17, 37, 41, 558, DateTimeKind.Local).AddTicks(3890),
                            IsActive = false,
                            Slug = "kingdom",
                            Title = "Kingdom"
                        });
