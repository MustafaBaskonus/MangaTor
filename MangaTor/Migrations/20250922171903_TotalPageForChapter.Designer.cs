...
namespace MangaTor.Migrations
{
    ...
    [Migration("20250922171903_TotalPageForChapter")]
    partial class TotalPageForChapter
    {
            ...
            modelBuilder.Entity("DAL.Entities.Comic", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ComicId = 1,
                            DateTime = new DateTime(2025, 9, 22, 20, 19, 3, 351, DateTimeKind.Local).AddTicks(9608),
                            IsActive = false,
                            Slug = "kingdom",
                            Title = "Kingdom"
                        });
