...
namespace MangaTor.Migrations
{
    ...
    [Migration("20250922172800_TotalPageForChapterFix")]
    partial class TotalPageForChapterFix
    {
            ...
            modelBuilder.Entity("DAL.Entities.Comic", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ComicId = 1,
                            DateTime = new DateTime(2025, 9, 22, 20, 28, 0, 203, DateTimeKind.Local).AddTicks(2040),
                            IsActive = false,
                            Slug = "kingdom",
                            Title = "Kingdom"
                        });
